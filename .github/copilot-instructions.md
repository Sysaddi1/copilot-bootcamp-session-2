...
- [UI Guidelines](../docs/ui-guidelines.md) - UI and style guidelines for the ToDo app
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles and quality rules for the ToDo app
